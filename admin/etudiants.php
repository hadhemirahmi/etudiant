...
<head>
  ...
  <title>Admin — Ajouter un étudiant</title>
...
<body>
  ...
  <div class="content">
    <div class="register-container">
      <h2 class="register-title">Ajouter un étudiant</h2>

      <form action="add_student_action.php" method="POST">

        <div class="mb-3">
          <label class="form-label">Nom complet</label>
          <input type="text" class="form-control" name="name" placeholder="Entrez le nom complet" required />
        </div>

        <div class="mb-3">
          <label class="form-label">Adresse e-mail</label>
          <input type="email" class="form-control" name="email" placeholder="Entrez l'email" required />
        </div>
